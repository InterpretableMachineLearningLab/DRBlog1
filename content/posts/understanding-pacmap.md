...
| --- | --- | --- | --- |
| `n_neighbors` | `10` | How many attractive neighbour pairs each point gets | Your dataset is large — pass `None` to let it scale. Very low values fragment the embedding. |
